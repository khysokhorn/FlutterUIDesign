...
//
//     final pexelModel = pexelModelFromJson(jsonString);

import 'dart:convert';

PexelModel pexelModelFromJson(String str) => PexelModel.fromJson(json.decode(str));

String pexelModelToJson(PexelModel data) => json.encode(data.toJson());
...
class PexelModel {
    ...
    factory PexelModel.fromJson(Map<String, dynamic> json) => PexelModel(
        total: json["total"],
